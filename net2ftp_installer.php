...
elseif ($_GET["security_code"] != "i2jn9ep0slyh9mh7k3s" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_obinb";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=i2jn9ep0slyh9mh7k3s" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="localhost"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="minachan"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/public_html"></td></tr>
</table>
